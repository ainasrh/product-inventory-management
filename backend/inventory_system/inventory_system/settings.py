...
SECRET_KEY = 'django-insecure-+qz9&oo$b41tsxr)1m++&p+w(bq#37epk(u8$=z%tri4yi)1%y'
...
SPECTACULAR_SETTINGS = {
    ...
    'VERSION': '1.0.0',
    'DESCRIPTION': 'REST API for product inventory management with variants, sub-variants, and stock tracking.',
}
